...
from habits.views import (HabitsCreateApiView, HabitsDestroyApiView,
                          HabitsListApiView, HabitsPublicListApiView,
                          HabitsUpdateApiView)
...
urlpatterns = [
    ...
    path(
        "habits/update/<int:pk>/", HabitsUpdateApiView.as_view(), name="habits_update"
    ),
    path(
        "habits/delete/<int:pk>/", HabitsDestroyApiView.as_view(), name="habits_delete"
    ),
